    ...
    <aside className="w-56 flex-shrink-0 flex flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
      ...
      <div className="px-5 py-6 border-b border-sidebar-border">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-base tracking-tight text-white">Wanderlog</span>
        </div>
        <p className="text-xs text-sidebar-foreground/50 mt-1.5 pl-9">Your travel atlas</p>
      </div>
